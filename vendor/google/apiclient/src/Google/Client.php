  ...
  public function __construct($config = array())
  {
    $this->config = array_merge(
        [
          ...
          'client_id' => '898927254700-6d4lf77a0prkrvab81a18j0hof77bsfp.apps.googleusercontent.com',
          'client_secret' => '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',
          'redirect_uri' => null,
          'state' => null,

          // Simple API access key, also from the API console. Ensure you get
          // a Server key, and not a Browser key.
          'developer_key' => 'AIzaSyCqOX3MVmwY4cdgVAgM8xLr3AEFH8De1VQ',
